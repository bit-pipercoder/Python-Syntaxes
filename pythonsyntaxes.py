# all of the syntaxes here are examples

print("Hello, World!") # prints hello to the output

# next syntaxes

name = "bernard" # create a variable called name so you can use it in prints

# print("") prints something to a output print() prints a variable length, of something to the output
print(name) # prints the variable name to the output and name contains bernard so it prints bernard

# concatenation
# concatenation is + from a string to a variable
# for example print("What is your name? " + name)

print("What is your name? " + name) # prints What is your name and Bernard to the output fully saying What is your name? Bernard
...
test = {
 ...
 # fun fact concatenation is useful you can use it like
Nerds = "Your long paragraph here" # then you can concatenate nerds to another line so it prints whats inside nerds
